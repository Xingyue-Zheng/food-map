...
> 面向浙大紫金港学生的选餐决策工具，解决"不知道吃什么"这件每天都要发生一次的小事。
> 店铺数据来自嬉游旅行指南《不能旅游，你还可以去这条堕落街吃遍全国啊》一文的实地探店记录。
...
浙大紫金港校区旁的龙宇街，一条长度不到 300 米的街上挤了五十多家美食店，被浙大学子称为「堕落街」，但学生普遍面临"吃什么"的决策困境：信息分散在各个平台，评价体系面向大众而非学生，缺少"人均 15 以内 / 步行 5 分钟 / 有学生折扣"这类真正影响学生决策的维度。
...
顶栏「逛吃分区」切换对以上四个模块同时生效，分区按文章给出的真实门牌划分：望月商铺 / 紫荆花北路 / 紫荆花城底商。
...
- 店铺数据为 **11 条硬编码数据**，写在 `index.html` 的 `D` 数组里。店名、地址门牌、营业时间、招牌单品、价格来自上述探店文章，属真实商户信息；但文章发布于 2021 年 1 月，商户可能已变动（文中德泓面馆就已搬过一次店）
- 该街实际有五十多家店，文章只详写了这 11 家，其余未收录
- 评分、评论数、热度值、学生评价、"实时更新" **均为模拟填充**，文章未提供这些数据，不存在数据源或后端
- "导航前往"只弹提示，未接入任何地图服务
- 收藏状态存在内存中，刷新即丢失
